      ...
      <section className="page-content">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {deliveryOptions.map((opt) => (
              ...
              >
                ...
                <p className="text-[13px] font-semibold text-sky-600 mb-1.5">{opt.time}</p>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-[0_2px_12px_rgba(15,23,42,0.04)] p-6 md:p-10 mb-4">
                ...
                <div className="flex flex-col items-center flex-shrink-0 w-5">
                  <div
                    className={`w-5 h-5 rounded-full border-2 border-white shadow flex-shrink-0 ${
                      i === 0 ? "bg-sky-600" : "bg-slate-200"
                    }`}
                    aria-hidden="true"
                  />
                  {i < trackingSteps.length - 1 && (
                    <div className="w-px flex-1 min-h-8 bg-gradient-to-b from-sky-200 to-slate-200 mt-1" aria-hidden="true" />
                  )}
                </div>
                {/* Content */}
          ...
          <div className="mt-8">
            <LocalizedClientLink
              href="/spara-order"
              className="inline-flex items-center gap-2 text-sm font-semibold text-sky-600 hover:text-sky-700 transition-colors duration-150"
            >
              Gå till Spåra order
